...
- `docker container ls`
  - 功能：列出當前正在執行的容器。
  - 出現章節：[3-2 認識 Docker 的命令行](./3-2-docker-basic-commands.md#docker-container-), [3-4 創建第一個容器](./3-4-bulk-comands-for-containers.md), [3-6 容器的attached和detached模式](./3-6-interact-with-container.md), [3-7 容器的交互模式](./3-7-how-Windows-and-Mac-run-docker-engine.md)

- `docker container ls -a`
  - 功能：列出當前所有容器，包括已停止的容器。
  - 出現章節：[3-2 認識 Docker 的命令行](./3-2-docker-basic-commands.md#docker-container-), [3-4 創建第一個容器](./3-4-bulk-comands-for-containers.md), [3-6 容器的attached和detached模式](./3-6-interact-with-container.md)
...
| 容器管理 | `docker container ls` | 列出當前正在執行的容器 | [3-2 認識 Docker 的命令行](./3-2-docker-basic-commands.md#docker-container-), [3-4 創建第一個容器](./3-4-bulk-comands-for-containers.md), [3-6 容器的attached和detached模式](./3-6-interact-with-container.md), [3-7 容器的交互模式](./3-7-how-Windows-and-Mac-run-docker-engine.md) |
|  | `docker container ls -a` | 列出當前所有容器，包括已停止的容器 | [3-2 認識 Docker 的命令行](./3-2-docker-basic-commands.md#docker-container-), [3-4 創建第一個容器](./3-4-bulk-comands-for-containers.md), [3-6 容器的attached和detached模式](./3-6-interact-with-container.md) |
